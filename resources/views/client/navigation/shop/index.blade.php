                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-1.jpg">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-2.jpg">
                                <ul class="product__hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-3.jpg">
                                <ul class="product__hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-4.jpg">
                                <ul class="product__hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item sale">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-5.jpg">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-6.jpg">
                                <ul class="product__hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-7.jpg">
                                <ul class="product__hover">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-8.jpg">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product__item sale">
                            <div class="product__item__pic set-bg"data-setbg="../assets/client/img/shop/shop-9.jpg">
                                <div class="label">Sale</div>
                                <ul class="product__hover">
