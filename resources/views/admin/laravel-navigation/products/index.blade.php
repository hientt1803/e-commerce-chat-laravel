        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                ...
                <div class="ms-auto me-4 mt-3">
                    <form action="{{ url('admin/products-management-search') }}" method="GET">
                        <div class="input-group input-group-sm mb-3">
                            <input type="text" class="form-control" style="width: 250px;" placeholder="Tên sản phẩm" name="search" value="{{ request()->search }}" aria-describedby="button-search-product">
                            <button class="btn btn-outline-secondary mb-0" type="submit" id="button-search-product"><i class="ni ni-send"></i></button>
                        </div>
                    </form>
                </div>
