        ...
        <div class="container-fluid py-4">
            <div class="card">
                <div class="card-header pb-0 px-3">
                    <h6 class="mb-0">{{ __('Thông tin cá nhân') }}</h6>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('fullname')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->fullname }}" type="text" placeholder="Name" id="user-name" name="fullname">
                                    @error('fullname')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="radio" {{ auth()->user()->gender == 1 ? 'checked' : '' }} id="gender_male" name="gender" value="1">
                                    <label for="gender_male">Nam</label><br>
                                    <input type="radio" {{ auth()->user()->gender == 0 ? 'checked' : '' }} id="gender_female" name="gender" value="0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="radio" id="role_user" {{ auth()->user()->role == 'user' ? 'checked' : '' }} name="role" value="user">
                                    <label for="role_user">Nhân viên</label><br>
                                    <input type="radio" id="role_admin" {{ auth()->user()->role == 'admin' ? 'checked' : '' }} name="role" value="admin">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <img id="currentImage" src="{{asset('storage/'. auth()->user()->image)}}" alt="Current Image" class="w-100 border-radius-lg shadow-sm">
